<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checkServices.aspx.cs" Inherits="OnlineStore.screens.checkServices" %>
...
<body>
    ...
    <div class="products">
        <div class="image">
            <img src="image/facial.jpg" /><br />
            <div class="buttons">
            <asp:Button runat="server" Text="Details" ID="buy" CssClass="button" OnClick="buy_Click" /></div>
        </div>
    </div>
    <div class="products" style="margin-left:40px">
        <div class="image">
            <img src="image/hairstyle.jpg" /><br />
           <div class="buttons"> 
            <asp:Button runat="server" Text="Details" ID="Button1" CssClass="button" OnClick="Button1_Click" /></div>
        </div>
    </div></div><br />
    <div class="all_product2" style="margin-top:-60px">
    <div class="products">
        <div class="image">
            <img src="image/henna.jpg" /><br />
            <div class="buttons">
            <asp:Button runat="server" Text="Details" ID="Button2" CssClass="button" /></div>
        </div>
    </div>
    <div class="products" style="margin-left:40px">
        <div class="image">
            <img src="image/nail_polish.jpg" /><br />
            <div class="buttons">
            <asp:Button runat="server" Text="Details" ID="Button3" CssClass="button" /></div>
        </div>
    </div></div>
